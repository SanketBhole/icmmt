<?php
                ...
                $email = $_POST['email'];
                $mobile = $_POST['mobile'];
                $sql = "INSERT INTO `unaux_31272816_icmmt`.`author`(`PaperId`,`PaperTitle`,`FName`, `MName`, `LName`, `Affiliation`, `Designation`, `AmountType`, `Amount`, `Payment`, `Country`, `State`, `UTR`, `Email`, `Mobile`) VALUES ('$paperid','$papertitle','$fname','$mname','$lname','$affiliation','$designation','$amounttype','$amount','$payment','$country','$state','$UTR','$email','$mobile');";
                // echo $sql;
